pub(super) use jcode_tui_style::theme::{
    ...
    dim_color, file_link_color, foreground_color, header_icon_color, header_name_color,
    header_session_color, muted_color, panel_color, pending_color, prompt_entry_bg_color,
